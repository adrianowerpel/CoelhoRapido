...
import database.dao.LoginAdministradorDAO;
 ...
 * @author aluno
 */
public class TelaLoginAdministrador extends javax.swing.JDialog {

    /**
     * Creates new form TelaLoginAdministrador
     */
    public TelaLoginAdministrador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void VerificarLogin(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VerificarLogin
        ...
        try {
            LoginAdministrador la = new LoginAdministradorDAO().BuscarLogin(TxtLogin.getText(), TxtSenha.getText());
            ...
            else
            {
                ...
                TelaAdministrador ta = new TelaAdministrador(null, true);
                ta.setVisible(true);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaLoginAdministrador dialog = new TelaLoginAdministrador(new javax.swing.JFrame(), true);
